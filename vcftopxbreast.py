...
#chrpath = "/home/lmogil/data/breast_cancer_imp"
chrpath = sys.argv[1]
#c = "20"
c = sys.argv[2]
...
snpfile = "/home/lauren/chr"+c+"_HRC.r1-1.GRCh37.wgs.mac5.sites.tab.gz"
posdict = {}
...
outdosage = gzip.open("enter_your_own_path/chr"+c+ ".dosage.txt.gz","wb")
